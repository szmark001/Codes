 ...
 * @author Ke Ma
 */
public class FilledRectangle extends Picture {
    ...
    FilledRectangle(double xcor, double ycor, double width, double height) {
        _pointa[0] = xcor;
        _pointa[1] = ycor;    
        _pointb[0] = xcor;
    ...
    FilledRectangle(double[] pointa, double[] pointb, double[]pointc, double[]pointd, List<Expr> rgb, double linewidth) {
        _pointa = pointa;
        _pointb = pointb;
        _pointc = pointc;
        _pointd = pointd;
    ...
    void draw(PrintWriter out) {
        ...
        out.println(_pointa[0] + " " + _pointa[1] + " " + "lineto" + " " + "fill");
    }
    ...
    Picture scale(double factor) {
        ...
        return new FilledRectangle(newpointa, newpointb, newpointc, newpointd, rgb, linewidth);
    }
